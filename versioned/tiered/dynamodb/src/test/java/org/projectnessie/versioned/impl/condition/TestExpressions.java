...
class TestExpressions {
  ...
  void updateMultiClause() {
    ...
    AliasCollectorImpl c = new AliasCollectorImpl();
    UpdateExpression e0p = e0.alias(c);
<<<<<<< HEAD:versioned/dynamodb/src/test/java/com/dremio/nessie/versioned/impl/condition/TestExpressions.java
    assertEquals(" "
...
>>>>>>> main_origin:versioned/tiered/dynamodb/src/test/java/org/projectnessie/versioned/impl/condition/TestExpressions.java
  }
